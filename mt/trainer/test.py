...
def evaluate_model(datapath, src, trg, model_name, bpe_folder, domain="None", batch_size=32, max_tokens=4096, num_workers=0):
    ...
    # Instanciate model
    litmodel = LitTransformer.load_from_checkpoint(lt_src=lt_src, lt_trg=lt_trg, checkpoint_path=CHECKPOINT)

    # Translate
    print("Generating translations...")
    y_pred, y_true = helpers.generate_translations(litmodel.model, lt_trg, test_loader, max_length=MAX_LENGTH, beam_width=BEAM_WIDTH)
